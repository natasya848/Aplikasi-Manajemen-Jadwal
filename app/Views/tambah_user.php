    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah User</h3>
                <p class="text-subtitle text-muted">Form untuk menambahkan user baru.</p>
            </div>
        </div>
    </div>
        ...
        <div class="card p-4">
            <div class="card-body">
                <form action="<?= base_url('user/tambah_user') ?>" method="post">
                    ...
                    <a href="<?= base_url('user/tabel_user') ?>" class="btn btn-danger mt-3"><i class="bi bi-x-circle"></i> Batal</a>
                </form>
            </div>
        </div>
    </section>
