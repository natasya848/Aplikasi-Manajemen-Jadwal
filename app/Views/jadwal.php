        ...
        <div class="card p-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex gap-2">
                    <a href="<?= base_url('jadwal/input_jadwal') ?>"><button class="btn btn-info"><i class="bi bi-plus"></i>Tambah</button></a>

                    <?php if (session()->get('level') == 1): ?>
                    <a href="<?= base_url('jadwal/dihapus_jadwal') ?>">
                        <button class="btn btn-primary">Data Jadwal yang Dihapus</button>
                    </a>
                    <?php endif; ?>
                </div>
            </div>
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-sm btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item text-warning" href="<?= base_url('jadwal/edit_jadwal/' . $value->id_jadwal) ?>">
                                                    <i class="fa fa-edit me-1"></i> Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-danger" href="<?= base_url('jadwal/delete_jadwal/' . $value->id_jadwal) ?>" onclick="return 
                                            ...
                                            <?php if (session()->get('level') == 1): ?>
                                            <li>
                                                <a class="dropdown-item text-info" href="<?= base_url('jadwal/detail_jadwal/' . $value->id_jadwal) ?>">
