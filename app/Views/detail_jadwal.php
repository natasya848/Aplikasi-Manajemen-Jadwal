      ...
      <h4>Detail Jadwal</h4>
        ...
        <div class="card-body">
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    <tr>
                        <td><?= esc($jadwal->nama_produk) ?></td>
                        <td><?= esc($jadwal->nama_klien) ?></td>
                        <td><?= esc($jadwal->tanggal) ?> <?= esc($jadwal->jam) ?></td>
                        <td>
                            <?php
                                $warna = '';
                            ...
                            ?>
                            <button class="btn btn-<?= $warna ?>"><?= esc($jadwal->status) ?></button>
                        </td>
            ...
            <a href="<?= base_url('jadwal/tabel_jadwal') ?>" class="btn btn-secondary">Kembali</a>
        </div>
    </div>
</div>
